...
function buildComposition(overrides: Partial<Composition> = {}): Composition {
  return {
    ...
    clips: [{ id: "clip_1", trackId: TRACK_ID, kind: "video", mediaAssetId: "med_1", startMs: 0, durationMs: 1000, trimInMs: 0, trimOutMs: 0, volume: 1, muted: false, speedPercent: 100, transitionInMs: 0, fadeInMs: 0, fadeOutMs: 0, transform: { x: 0, y: 0, scale: 1, rotation: 0, opacity: 1 }, audioPatches: [] }],
    watermarkRemovals: [],
    subtitles: [],
